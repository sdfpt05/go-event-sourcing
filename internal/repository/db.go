...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.saveEventStmt, err = db.PrepareContext(ctx, saveEvent); err != nil {
		return nil, fmt.Errorf("error preparing query SaveEvent: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	...
	if q.saveEventStmt != nil {
		if cerr := q.saveEventStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing saveEventStmt: %w", cerr)
		}
	}
	return err
}
